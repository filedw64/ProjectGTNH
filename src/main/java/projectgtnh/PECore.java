...
import projectgtnh.config.NBTWhitelistParser;
import projectgtnh.config.ProjectGTNHConfig;
import projectgtnh.emc.EMCMapper;
import projectgtnh.events.ConnectionHandler;
import projectgtnh.events.PlayerEvents;
import projectgtnh.events.TickEvents;
...
import projectgtnh.impl.IMCHandler;
import projectgtnh.integration.Integration;
import projectgtnh.network.PacketHandler;
import projectgtnh.network.ThreadCheckUUID;
import projectgtnh.network.ThreadCheckUpdate;
import projectgtnh.network.commands.ProjectGTNHCMD;
import projectgtnh.playerData.Transmutation;
import projectgtnh.playerData.TransmutationOffline;
import projectgtnh.proxies.IProxy;
import projectgtnh.utils.AchievementHandler;
import projectgtnh.utils.Constants;
import projectgtnh.utils.GuiHandler;
...
public class PECore
{
	...
	public void preInit(FMLPreInitializationEvent event)
	{
		...
		ProjectGTNHConfig.init(new File(CONFIG_DIR, "ProjectGTNH.cfg"));
