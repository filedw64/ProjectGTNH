...
import projectgtnh.gameObjs.items.IStepAssister;
...
public final class PlayerChecks
{
	...
	public static void resetProjectileCooldown(EntityPlayerMP player) {
		projectileCooldowns.put(player, ProjectGTNHConfig.projectileCooldown);
	}
	...
	public static void resetGemCooldown(EntityPlayerMP player) {
		gemChestCooldowns.put(player, ProjectGTNHConfig.gemChestCooldown);
	}
