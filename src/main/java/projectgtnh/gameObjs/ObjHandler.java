...
import projectgtnh.gameObjs.blocks.AlchemicalChest;
import projectgtnh.gameObjs.blocks.Collector;
import projectgtnh.gameObjs.blocks.Condenser;
import projectgtnh.gameObjs.blocks.CondenserMK2;
import projectgtnh.gameObjs.blocks.FuelBlock;
import projectgtnh.gameObjs.blocks.InterdictionTorch;
import projectgtnh.gameObjs.blocks.MatterBlock;
import projectgtnh.gameObjs.blocks.MatterFurnace;
import projectgtnh.gameObjs.blocks.NovaCataclysm;
import projectgtnh.gameObjs.blocks.NovaCatalyst;
import projectgtnh.gameObjs.blocks.Pedestal;
import projectgtnh.gameObjs.blocks.Relay;
import projectgtnh.gameObjs.blocks.TransmutationStone;
import projectgtnh.gameObjs.customRecipes.RecipeAlchemyBag;
import projectgtnh.gameObjs.customRecipes.RecipeShapedKleinStar;
import projectgtnh.gameObjs.customRecipes.RecipeShapelessHidden;
import projectgtnh.gameObjs.customRecipes.RecipesCovalenceRepair;
import projectgtnh.gameObjs.entity.EntityFireProjectile;
import projectgtnh.gameObjs.entity.EntityHomingArrow;
...
import projectgtnh.gameObjs.items.AlchemicalBag;
import projectgtnh.gameObjs.items.AlchemicalFuel;
import projectgtnh.gameObjs.items.CataliticLens;
import projectgtnh.gameObjs.items.CovalenceDust;
import projectgtnh.gameObjs.items.DestructionCatalyst;
import projectgtnh.gameObjs.items.DiviningRodHigh;
import projectgtnh.gameObjs.items.DiviningRodLow;
import projectgtnh.gameObjs.items.DiviningRodMedium;
import projectgtnh.gameObjs.items.EvertideAmulet;
import projectgtnh.gameObjs.items.GemEternalDensity;
import projectgtnh.gameObjs.items.HyperkineticLens;
import projectgtnh.gameObjs.items.KleinStar;
import projectgtnh.gameObjs.items.Matter;
import projectgtnh.gameObjs.items.MercurialEye;
import projectgtnh.gameObjs.items.PEManual;
import projectgtnh.gameObjs.items.PhilosophersStone;
import projectgtnh.gameObjs.items.RepairTalisman;
import projectgtnh.gameObjs.items.TimeWatch;
import projectgtnh.gameObjs.items.Tome;
import projectgtnh.gameObjs.items.TransmutationTablet;
import projectgtnh.gameObjs.items.VolcaniteAmulet;
import projectgtnh.gameObjs.items.armor.DMArmor;
...
import projectgtnh.gameObjs.items.armor.GemLegs;
import projectgtnh.gameObjs.items.armor.RMArmor;
import projectgtnh.gameObjs.items.itemBlocks.ItemAlchemyChestBlock;
import projectgtnh.gameObjs.items.itemBlocks.ItemCollectorBlock;
import projectgtnh.gameObjs.items.itemBlocks.ItemCondenserBlock;
import projectgtnh.gameObjs.items.itemBlocks.ItemDMFurnaceBlock;
import projectgtnh.gameObjs.items.itemBlocks.ItemFuelBlock;
import projectgtnh.gameObjs.items.itemBlocks.ItemMatterBlock;
import projectgtnh.gameObjs.items.itemBlocks.ItemRMFurnaceBlock;
import projectgtnh.gameObjs.items.itemBlocks.ItemRelayBlock;
import projectgtnh.gameObjs.items.itemBlocks.ItemTransmutationBlock;
import projectgtnh.gameObjs.items.itemEntities.FireProjectile;
import projectgtnh.gameObjs.items.itemEntities.LavaOrb;
import projectgtnh.gameObjs.items.itemEntities.LensExplosive;
import projectgtnh.gameObjs.items.itemEntities.LightningProjectile;
import projectgtnh.gameObjs.items.itemEntities.LootBallItem;
import projectgtnh.gameObjs.items.itemEntities.RandomizerProjectile;
import projectgtnh.gameObjs.items.itemEntities.WaterOrb;
import projectgtnh.gameObjs.items.rings.Arcana;
import projectgtnh.gameObjs.items.rings.ArchangelSmite;
import projectgtnh.gameObjs.items.rings.BlackHoleBand;
import projectgtnh.gameObjs.items.rings.BodyStone;
import projectgtnh.gameObjs.items.rings.HarvestGoddess;
import projectgtnh.gameObjs.items.rings.Ignition;
import projectgtnh.gameObjs.items.rings.IronBand;
import projectgtnh.gameObjs.items.rings.LifeStone;
import projectgtnh.gameObjs.items.rings.MindStone;
import projectgtnh.gameObjs.items.rings.SWRG;
import projectgtnh.gameObjs.items.rings.SoulStone;
import projectgtnh.gameObjs.items.rings.VoidRing;
import projectgtnh.gameObjs.items.rings.Zero;
import projectgtnh.gameObjs.items.tools.DarkAxe;
import projectgtnh.gameObjs.items.tools.DarkHammer;
import projectgtnh.gameObjs.items.tools.DarkHoe;
import projectgtnh.gameObjs.items.tools.DarkPick;
import projectgtnh.gameObjs.items.tools.DarkShears;
import projectgtnh.gameObjs.items.tools.DarkShovel;
import projectgtnh.gameObjs.items.tools.DarkSword;
import projectgtnh.gameObjs.items.tools.RedAxe;
import projectgtnh.gameObjs.items.tools.RedHammer;
import projectgtnh.gameObjs.items.tools.RedHoe;
import projectgtnh.gameObjs.items.tools.RedKatar;
import projectgtnh.gameObjs.items.tools.RedPick;
import projectgtnh.gameObjs.items.tools.RedShears;
import projectgtnh.gameObjs.items.tools.RedShovel;
import projectgtnh.gameObjs.items.tools.RedStar;
import projectgtnh.gameObjs.items.tools.RedSword;
...
import projectgtnh.gameObjs.tiles.InterdictionTile;
...
import projectgtnh.utils.EnumArmorType;
...
public class ObjHandler
{
	...
	public static void addRecipes()
	{
		...
		if (ProjectGTNHConfig.altCraftingMat)
		{
		...
		//Tome
		if (ProjectGTNHConfig.craftableTome)
		{
