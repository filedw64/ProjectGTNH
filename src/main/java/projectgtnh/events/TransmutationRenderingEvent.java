...
import projectgtnh.utils.MetaBlock;
import projectgtnh.utils.WorldTransmutations;
...
public class TransmutationRenderingEvent 
{
	...
	private void drawAll()
	{
		...
		GL11.glColor4f(1.0f, 1.0f, 1.0f, ProjectGTNHConfig.pulsatingOverlay ? getPulseProportion() * 0.60f : 0.35f);
