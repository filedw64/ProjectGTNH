...
import projectgtnh.emc.collector.DumpToFileCollector;
import projectgtnh.api.event.EMCRemapEvent;
...
import projectgtnh.emc.mappers.APICustomConversionMapper;
import projectgtnh.emc.mappers.Chisel2Mapper;
import projectgtnh.emc.arithmetics.HiddenFractionArithmetic;
import projectgtnh.emc.mappers.APICustomEMCMapper;
import projectgtnh.emc.mappers.CraftingMapper;
import projectgtnh.emc.mappers.CustomEMCMapper;
import projectgtnh.emc.mappers.IEMCMapper;
import projectgtnh.emc.mappers.LazyMapper;
import projectgtnh.emc.mappers.OreDictionaryMapper;
import projectgtnh.emc.mappers.SmeltingMapper;
import projectgtnh.emc.mappers.customConversions.CustomConversionMapper;
import projectgtnh.emc.pregenerated.PregeneratedEMC;
import projectgtnh.playerData.Transmutation;
import projectgtnh.utils.PELogger;
import projectgtnh.utils.PrefixConfiguration;
...
public final class EMCMapper 
{
	...
	public static void map()
	{
		List<IEMCMapper<NormalizedSimpleStack, Integer>> emcMappers = Arrays.asList(
				...
				new CustomEMCMapper(),
				new CraftingMapper(),
				new projectgtnh.emc.mappers.FluidMapper(),
				new SmeltingMapper(),
	...
	/**
	 * Remove all entrys from the map, that are not {@link projectgtnh.emc.NormalizedSimpleStack.NSSItem}s, have a value < 0 or WILDCARD_VALUE as metadata.
	 * @param map
	 */
