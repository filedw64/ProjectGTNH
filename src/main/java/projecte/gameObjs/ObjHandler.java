...
import projecte.config.ProjectEConfig;
import projecte.gameObjs.blocks.AlchemicalChest;
import projecte.gameObjs.blocks.Collector;
import projecte.gameObjs.blocks.Condenser;
import projecte.gameObjs.blocks.CondenserMK2;
import projecte.gameObjs.blocks.FuelBlock;
import projecte.gameObjs.blocks.InterdictionTorch;
import projecte.gameObjs.blocks.MatterBlock;
import projecte.gameObjs.blocks.MatterFurnace;
import projecte.gameObjs.blocks.NovaCataclysm;
import projecte.gameObjs.blocks.NovaCatalyst;
import projecte.gameObjs.blocks.Pedestal;
import projecte.gameObjs.blocks.Relay;
import projecte.gameObjs.blocks.TransmutationStone;
import projecte.gameObjs.customRecipes.RecipeAlchemyBag;
import projecte.gameObjs.customRecipes.RecipeShapedKleinStar;
import projecte.gameObjs.customRecipes.RecipeShapelessHidden;
import projecte.gameObjs.customRecipes.RecipesCovalenceRepair;
import projecte.gameObjs.entity.EntityFireProjectile;
import projecte.gameObjs.entity.EntityHomingArrow;
...
import projecte.gameObjs.items.AlchemicalBag;
import projecte.gameObjs.items.AlchemicalFuel;
import projecte.gameObjs.items.CataliticLens;
import projecte.gameObjs.items.CovalenceDust;
import projecte.gameObjs.items.DestructionCatalyst;
import projecte.gameObjs.items.DiviningRodHigh;
import projecte.gameObjs.items.DiviningRodLow;
import projecte.gameObjs.items.DiviningRodMedium;
import projecte.gameObjs.items.EvertideAmulet;
import projecte.gameObjs.items.GemEternalDensity;
import projecte.gameObjs.items.HyperkineticLens;
import projecte.gameObjs.items.KleinStar;
import projecte.gameObjs.items.Matter;
import projecte.gameObjs.items.MercurialEye;
import projecte.gameObjs.items.PEManual;
import projecte.gameObjs.items.PhilosophersStone;
import projecte.gameObjs.items.RepairTalisman;
import projecte.gameObjs.items.TimeWatch;
import projecte.gameObjs.items.Tome;
import projecte.gameObjs.items.TransmutationTablet;
import projecte.gameObjs.items.VolcaniteAmulet;
import projecte.gameObjs.items.armor.DMArmor;
import projecte.gameObjs.items.armor.GemChest;
import projecte.gameObjs.items.armor.GemFeet;
import projecte.gameObjs.items.armor.GemHelmet;
import projecte.gameObjs.items.armor.GemLegs;
import projecte.gameObjs.items.armor.RMArmor;
import projecte.gameObjs.items.itemBlocks.ItemAlchemyChestBlock;
import projecte.gameObjs.items.itemBlocks.ItemCollectorBlock;
import projecte.gameObjs.items.itemBlocks.ItemCondenserBlock;
import projecte.gameObjs.items.itemBlocks.ItemDMFurnaceBlock;
import projecte.gameObjs.items.itemBlocks.ItemFuelBlock;
import projecte.gameObjs.items.itemBlocks.ItemMatterBlock;
import projecte.gameObjs.items.itemBlocks.ItemRMFurnaceBlock;
import projecte.gameObjs.items.itemBlocks.ItemRelayBlock;
import projecte.gameObjs.items.itemBlocks.ItemTransmutationBlock;
import projecte.gameObjs.items.itemEntities.FireProjectile;
import projecte.gameObjs.items.itemEntities.LavaOrb;
import projecte.gameObjs.items.itemEntities.LensExplosive;
import projecte.gameObjs.items.itemEntities.LightningProjectile;
import projecte.gameObjs.items.itemEntities.LootBallItem;
import projecte.gameObjs.items.itemEntities.RandomizerProjectile;
import projecte.gameObjs.items.itemEntities.WaterOrb;
import projecte.gameObjs.items.rings.Arcana;
import projecte.gameObjs.items.rings.ArchangelSmite;
import projecte.gameObjs.items.rings.BlackHoleBand;
import projecte.gameObjs.items.rings.BodyStone;
import projecte.gameObjs.items.rings.HarvestGoddess;
import projecte.gameObjs.items.rings.Ignition;
import projecte.gameObjs.items.rings.IronBand;
import projecte.gameObjs.items.rings.LifeStone;
import projecte.gameObjs.items.rings.MindStone;
import projecte.gameObjs.items.rings.SWRG;
import projecte.gameObjs.items.rings.SoulStone;
import projecte.gameObjs.items.rings.VoidRing;
import projecte.gameObjs.items.rings.Zero;
import projecte.gameObjs.items.tools.DarkAxe;
import projecte.gameObjs.items.tools.DarkHammer;
import projecte.gameObjs.items.tools.DarkHoe;
import projecte.gameObjs.items.tools.DarkPick;
import projecte.gameObjs.items.tools.DarkShears;
import projecte.gameObjs.items.tools.DarkShovel;
import projecte.gameObjs.items.tools.DarkSword;
import projecte.gameObjs.items.tools.RedAxe;
import projecte.gameObjs.items.tools.RedHammer;
import projecte.gameObjs.items.tools.RedHoe;
import projecte.gameObjs.items.tools.RedKatar;
import projecte.gameObjs.items.tools.RedPick;
import projecte.gameObjs.items.tools.RedShears;
import projecte.gameObjs.items.tools.RedShovel;
import projecte.gameObjs.items.tools.RedStar;
import projecte.gameObjs.items.tools.RedSword;
import projecte.gameObjs.tiles.AlchChestTile;
import projecte.gameObjs.tiles.CollectorMK1Tile;
import projecte.gameObjs.tiles.CollectorMK2Tile;
import projecte.gameObjs.tiles.CollectorMK3Tile;
import projecte.gameObjs.tiles.CondenserMK2Tile;
import projecte.gameObjs.tiles.CondenserTile;
import projecte.gameObjs.tiles.DMFurnaceTile;
import projecte.gameObjs.tiles.DMPedestalTile;
import projecte.gameObjs.tiles.InterdictionTile;
import projecte.gameObjs.tiles.RMFurnaceTile;
import projecte.gameObjs.tiles.RelayMK1Tile;
import projecte.gameObjs.tiles.RelayMK2Tile;
import projecte.gameObjs.tiles.RelayMK3Tile;
import projecte.utils.Constants;
import projecte.utils.EnumArmorType;
