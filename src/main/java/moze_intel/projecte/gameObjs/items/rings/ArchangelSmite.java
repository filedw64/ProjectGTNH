...
public class ArchangelSmite extends RingToggle implements IPedestalItem, IModeChanger
{
	...
	public void updateInPedestal(World world, int x, int y, int z) {
		if (world.isRemote || ProjectEConfig.archangelPedCooldown == -1) return;
	...
	public List<String> getPedestalDescription() {
		...
		if (ProjectEConfig.archangelPedCooldown != -1) {
			...
			list.add(EnumChatFormatting.BLUE + String.format(StatCollector.translateToLocal("pe.archangel.pedestal2"),
